...
namespace LTDT_DoAnCuoiKi_Nhom8
{
    public partial class FormGraph : Form
    {
        ...
        private LTDT_DoAnCuoiKi_Nhom8.Class_FS_Graph.FS_Graph Dothi = new Class_FS_Graph.FS_Graph();
        ...
        private void btnLamMoi_Click(object sender, EventArgs e)
        {
            ...
            LTDT_DoAnCuoiKi_Nhom8.Class_FS_Graph.FS_Graph Dothi = new Class_FS_Graph.FS_Graph();
            FS = string.Empty;
            FS1 = string.Empty;
            TPLT = new string[] { };
            i = 0;
